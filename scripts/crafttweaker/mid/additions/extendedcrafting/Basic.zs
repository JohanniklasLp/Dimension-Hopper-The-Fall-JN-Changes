...
static shapedHolders as Holder[] = [
	...
	//mist
	Util.simpleShaped(<mist:portal_base:1>, "portaltop", [<dimdoors:stable_fabric>, <psi:material:1>, <naturesaura:infused_stone>, <naturesaura:gold_powder>]), //misty portal top
	Util.simpleShaped(<mist:portal_base>, "portalbottom", [<dimdoors:stable_fabric>, <psi:material:1>, <naturesaura:infused_stone>, <naturesaura:gold_powder>]), //misty portal bottom
